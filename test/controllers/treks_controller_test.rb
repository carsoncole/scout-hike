...
class TreksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trek" do
    assert_difference('Trek.count') do
      post treks_url, params: { trek: { date: @trek.date, distance_in_miles: @trek.distance_in_miles, user_id: @trek.user_id } }
    end
  ...
  test "should update trek" do
    patch trek_url(@trek), params: { trek: { date: @trek.date, distance_in_miles: @trek.distance_in_miles, user_id: @trek.user_id } }
